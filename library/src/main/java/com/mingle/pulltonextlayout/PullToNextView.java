...
//       hiddenHeaderView();
    ...
    private void hiddenFootView() {
        ...
        footPromptTV = (TextView) mFootView.findViewById(R.id.prompt_tv);
    ...
    private void hiddenHeaderView() {
        ...
        headPromptTV = (TextView) mHeaderView.findViewById(R.id.prompt_tv);
    ...
    private int changingHeaderViewTopMargin(int deltaY) {
        ...
        if (newTopMargin < -mHeadViewHeight) {
            ...
            if (!isHashNext) {
                footPromptTV.setText("");
            } else if (newTopMargin < -3 * mHeadViewHeight) {

                footPromptTV.setText("上拉显示商品详情");
            } else {
                footPromptTV.setText("上拉显示商品详情");
...
//                headPromptTV.setText("释放返回商品详情");
            } else {
                headPromptTV.setText("下拉返回商品详情");
