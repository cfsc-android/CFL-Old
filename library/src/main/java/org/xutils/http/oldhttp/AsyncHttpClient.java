...
/**
 * 类名：AsyncHttpClient 类描述：Http请求处理类 作者：CJ 创建时间：2014-10-24-下午3:06:35 修改记录： 修改人　　
 * 修改时间　　 版本 描述 ----------------------------------------------------------
 * 
 * 
 * ---------------------------------------------------------- Copyright
...
public class AsyncHttpClient {
	...
	private static final String HOST = "http://m.tepin.com/";
	...
	public AsyncHttpClient() {
		...
		HttpProtocolParams.setUserAgent(httpParams,
				String.format("tepin/%s (+" + HOST + ")", VERSION));
	...
	public void get(Context context, String url, RequestParams params,
			AsyncHttpResponseHandler responseHandler) {
		Log.e("url----------------------", (getUrlWithQueryString(url, params)));
