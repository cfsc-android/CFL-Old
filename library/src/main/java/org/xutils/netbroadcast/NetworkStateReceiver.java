package org.xutils.netbroadcast;
...
import org.xutils.NetUtil.netType;

 /**
 * 类名：NetworkStateReceiver
...
public class NetworkStateReceiver extends BroadcastReceiver
{
	...
	private static ArrayList<WKXNetChangeObserver> netChangeObserverArrayList = new ArrayList<WKXNetChangeObserver>();
	...
	public void onReceive(Context context, Intent intent)
	{
						...
						TA_ANDROID_NET_CHANGE_ACTION))
		{
			...
			{
				LogUtils.i("网络连接成功.");
				netType = NetUtil.getAPNType(context);
	...
	private void notifyObserver()
	{
		...
		{
			WKXNetChangeObserver observer = netChangeObserverArrayList.get(i);
			if (observer != null)
			{
	 ...
	 *            observerKey
	 */
	public static void registerObserver(WKXNetChangeObserver observer)
	{
		if (netChangeObserverArrayList == null)
		{
			netChangeObserverArrayList = new ArrayList<WKXNetChangeObserver>();
		}
	 ...
	 *            observerKey
	 */
	public static void removeRegisterObserver(WKXNetChangeObserver observer)
	{
		if (netChangeObserverArrayList != null)
		{
