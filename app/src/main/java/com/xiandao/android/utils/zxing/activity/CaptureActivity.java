package com.xiandao.android.utils.zxing.activity;
...
import com.xiandao.android.utils.zxing.camera.CameraManager;
import com.xiandao.android.utils.zxing.decoding.CaptureActivityHandler;
import com.xiandao.android.utils.zxing.decoding.InactivityTimer;
import com.xiandao.android.utils.zxing.decoding.RGBLuminanceSource;
import com.xiandao.android.utils.zxing.view.ViewfinderView;
    ...
    public void IfOpenLight(View v) {
        ...
        switch (ifOpenLight % 2) {
            case 0:
                ...
                iv_light.setImageResource(R.mipmap.tongyong_sdt);
                break;
            case 1:
                //开闪光灯
                CameraManager.get().openLight();
                iv_light.setImageResource(R.mipmap.tongyong_sdt_open);
                break;
            default:
                break;
        }
