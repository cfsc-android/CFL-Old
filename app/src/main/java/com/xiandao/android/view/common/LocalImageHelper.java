...
public class LocalImageHelper {
    ...
    public String setCameraImgPath() {
        String foloder = AndroidApplication.getInstance().getCachePath()
                + "/PostPicture/";
    ...
    private LocalImageHelper(AndroidApplication context) {
    ...
    public static void init(AndroidApplication context) {
