...
public class MySpiner extends RelativeLayout implements OnClickListener, AbstractSpinerAdapter.IOnItemSelectListener {
     ...
     * @param context
     */
    public MySpiner(Context context, AttributeSet attrs) {
        super(context, attrs);
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        inflater.inflate(R.layout.my_spiner, this, true);
    ...
    public void onItemClick(int pos) {
        ...
        if (mItemSelectListener != null) {
            mItemSelectListener.onClickListener(pos);
        }
