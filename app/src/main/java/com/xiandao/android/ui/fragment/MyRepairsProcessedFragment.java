...
/**
 * 此类描述的是:我的工单已处理fragment
 *
 * @author TanYong
 *         create at 2017/5/6 14:15
 */
public class MyRepairsProcessedFragment extends BaseLazyFragment {
...
//                startActivity(intent);
    ...
    private void queryRepairsLis() {
        ...
        ApiHttpResult.queryRepairsList(getActivity(), new String[]{
                ...
                new Object[]{
                        "1", loginUserEntity.getUserId(), loginUserEntity.getMobileNumber(), page, pageSize, startTime, endTime, workOrderType},
                new HttpUtils.DataCallBack<Object>() {
                    ...
                    public void callBack(Object o) {
                        ...
                        if (o != null) {
                            ...
                            if (myRepairsListEntity != null) {
                                if (myRepairsListEntity.getResultCode().equals("0")) {
                                    ...
                                    if (myRepairsEntities != null && myRepairsEntities.size() > 0) {
                                        ...
                                        myRepairsListEntities.addAll(myRepairsListEntity.getRepairsEntityList());
                                        if (ptrlv_my_repairs_list != null) {
                                            ptrlv_my_repairs_list.onRefreshComplete();
                                        }
                                        myRepairsListAdapter.notifyDataSetChanged();
                                    } else {
                                        Tools.showPrompt("没有已处理工单数据");
                                    }
                                } else {
