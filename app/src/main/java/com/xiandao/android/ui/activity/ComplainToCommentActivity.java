...
import com.xiandao.android.ui.fragment.ComplainToCommentFragment;
...
/**
 * 此类描述的是:投诉去评价activity
 *
 * @author TanYong
 *         create at 2017/6/2 10:05
 */
@ContentView(R.layout.activity_complain_detail)
public class ComplainToCommentActivity extends BaseActivity implements View.OnClickListener {
     ...
     * 两个Fragment（页面）
     */
    private ComplainToCommentFragment complainToCommentFragment;
    ...
    private void init() {
        ...
        complainToCommentFragment = new ComplainToCommentFragment();
        ...
        complainToCommentFragment.setArguments(bundleDetail);
        complainPlanFragment.setArguments(bundleJindu);

        fragmentList.add(complainToCommentFragment);
        ...
        vpContent.setAdapter(new ComplainToCommentActivity.MyFrageStatePagerAdapter(getSupportFragmentManager()));
    }
