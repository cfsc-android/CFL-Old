...
import com.xiandao.android.ui.fragment.ComplainFinishFragment;
...
public class ComplainFinishActivity extends BaseActivity implements View.OnClickListener {
     ...
     * 两个Fragment（页面）
     */
    private ComplainFinishFragment complainFinishFragment;
    ...
    private void init() {
        ...
        complainFinishFragment = new ComplainFinishFragment();
        ...
        complainFinishFragment.setArguments(bundleDetail);
        complainPlanFragment.setArguments(bundleJindu);

        fragmentList.add(complainFinishFragment);
        ...
        vpContent.setAdapter(new ComplainFinishActivity.MyFrageStatePagerAdapter(getSupportFragmentManager()));
    }
