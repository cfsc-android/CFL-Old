...
import com.xiandao.android.ui.fragment.ComplainComfirmResultFragment;
...
/**
 * 此类描述的是:投诉确认结果activity
 *
 * @author TanYong
 *         create at 2017/6/2 10:05
 */
@ContentView(R.layout.activity_complain_detail)
public class ComplainConfirmResultActivity extends BaseActivity implements View.OnClickListener {
     ...
     * 两个Fragment（页面）
     */
    private ComplainComfirmResultFragment complainComfirmResultFragment;
    ...
    private void init() {
        ...
        complainComfirmResultFragment = new ComplainComfirmResultFragment();
        ...
        complainComfirmResultFragment.setArguments(bundleDetail);
        complainPlanFragment.setArguments(bundleJindu);

        fragmentList.add(complainComfirmResultFragment);
        ...
        vpContent.setAdapter(new ComplainConfirmResultActivity.MyFrageStatePagerAdapter(getSupportFragmentManager()));
    }
